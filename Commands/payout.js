    ...
    async execute(message, args) {
        ...
        if (message.author.id === "") {
            ...
            let successEmbed = new Discord.MessageEmbed()
                ...
                .setColor(colors.green)
                .setFooter(message.client.user.username, message.client.user.displayAvatarURL())
                .setDescription(`Successfully payed out **${robloxUsername}** :moneybag: ${robuxAmount}!\n\n**- - More Info - - **\nRoblox Username: ${robloxUsername}\nPayed Robux: ${robuxAmount}\nGroup ID: 4075500`);
                ...
                sMessage.awaitReactions(filter, {
                    ...
                    if (reaction.emoji.name === '✅') {
                        ...
                        let payoutCanceledEmbed = new Discord.MessageEmbed()
                            ...
                            .setColor(colors.red)
                            .setFooter(message.client.user.username, message.client.user.displayAvatarURL())
                            .setDescription(`The payout to ${robloxUsername} of :moneybag: ${robuxAmount} was cancelled, if this was a mistake please try the command again.`)
